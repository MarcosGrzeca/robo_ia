...
function montarProlog() {
	...
	*/
	...
	texto += "can(mover_robo_resgate(Robo,V,W), connects(V,W) & local(Robo,V) & robo_resgate_vida(Robo)).\n";
	texto += "can(mover_robo_forca(Robo,V,W), connects(V,W) & local(Robo,V) & robo_forca_bruta(Robo)).\n";
	...
	texto += "add(local(Robo,W), mover_robo_resgate(Robo,_,W)).\n";
	texto += "add(local(Robo,W), mover_robo_forca(Robo,_,W)).\n";
	...
	texto += "del(local(Robo,V), mover_robo_forca(Robo,V,_)).\n";
	texto += "del(local(Robo,V), mover_robo_resgate(Robo,V,_)).\n";
